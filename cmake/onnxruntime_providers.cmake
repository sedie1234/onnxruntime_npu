...
if(onnxruntime_USE_KETINPU)
  set(PROVIDERS_KETINPU onnxruntime_providers_ketinpu)
endif()
if(onnxruntime_USE_KETINPU)
  set(PROVIDERS_KETINPU onnxruntime_providers_ketinpu)
endif()
...
if (onnxruntime_USE_KETINPU)
  add_definitions(-DUSE_KETINPU=1)
  file(GLOB_RECURSE onnxruntime_providers_ketinpu_cc_srcs
    "${ONNXRUNTIME_ROOT}/core/providers/ketinpu/*.h"
    "${ONNXRUNTIME_ROOT}/core/providers/ketinpu/*.cc"
  )

  source_group(TREE ${ONNXRUNTIME_ROOT}/core FILES ${onnxruntime_providers_ketinpu_cc_srcs})
  onnxruntime_add_static_library(onnxruntime_providers_ketinpu ${onnxruntime_providers_ketinpu_cc_srcs})
  onnxruntime_add_include_to_target(onnxruntime_providers_ketinpu onnxruntime_common onnxruntime_framework onnx onnx_proto ${PROTOBUF_LIB} flatbuffers)
  target_link_libraries(onnxruntime_providers_ketinpu -L$ENV{LD_LIBRARY_PATH})
  add_dependencies(onnxruntime_providers_ketinpu ${onnxruntime_EXTERNAL_DEPENDENCIES})
  set_target_properties(onnxruntime_providers_ketinpu PROPERTIES FOLDER "ONNXRuntime")
  target_include_directories(onnxruntime_providers_ketinpu PRIVATE ${ONNXRUNTIME_ROOT} ${eigen_INCLUDE_DIRS})
  set_target_properties(onnxruntime_providers_ketinpu PROPERTIES LINKER_LANGUAGE CXX)
endif()
