...
#define BACKEND_DEVICE BACKEND_PROC BACKEND_DNNL BACKEND_OPENVINO BACKEND_NUPHAR BACKEND_TVM BACKEND_OPENBLAS BACKEND_MIGRAPHX BACKEND_ACL BACKEND_ARMNN BACKEND_DML BACKEND_KETINPU
...
#if USE_KETINPU
#define BACKEND_KETINPU "-KETINPU"
#else
#define BACKEND_KETINPU ""
#endif
